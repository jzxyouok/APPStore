...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public interface IconTextTabProvider {
        public int getPageIconTextResId(int position);
    }
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                addIconTextTab(i,
                        ...
                        ((IconTextTabProvider) pager.getAdapter())
                                .getPageIconTextResId(i));
            } else {
    ...
    private void addIconTextTab(final int position, String title,
                                int res_imageId) {
        View view = View.inflate(getContext(), R.layout.tab_icon_text, null);
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTextTabProvider) {
                ImageView tab_image = (ImageView) v
                        .findViewById(R.id.tab_iamge);
                TextView tab_text = (TextView) v.findViewById(R.id.tab_text);

                if (mSelectPosititon == i) {
                    tab_image.setImageResource(((IconTextTabProvider) pager
                            .getAdapter()).getPageIconTextResId(i));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft + XgoUIUtils.dip2px(10), height - indicatorHeight, lineRight - XgoUIUtils.dip2px(10), height,
                rectPaint);
