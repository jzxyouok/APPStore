...
import play.wm.ljb.com.wmiplay.protocol.GameTabProtocol;
 ...
 */
public class GameTabFragment extends BaseTabFragment<GameTabBean> implements AdapterView.OnItemClickListener {

    private ListView  mListView;
    private SwipeRefreshLayout mSwipe_refresh;
    private  GameTabProtocol mProtocol;
    private  AppTabAdapter mAdapter;

    @Override
    public View initContentView() {
        View view = View.inflate(getActivity(), R.layout.tab_fragment_game,null);
...
//        mSwipe_refresh.setProgressViewEndTarget(true, 100);
    ...
    public PageStateFrameLayout.LoadResult load() {
        ...
        mProtocol = new GameTabProtocol();
        mData = mProtocol.load(0);
        return checkData(mData);
    }

    @Override
    public PageStateFrameLayout.LoadResult checkData(GameTabBean data) {
        if(data==null){
