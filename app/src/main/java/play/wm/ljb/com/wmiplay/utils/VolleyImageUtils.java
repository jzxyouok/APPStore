...
//    /**
//     * æ ¹æ®æ˜¾ç¤ºçš„æœ€å¤§å®½åº¦æˆ–æœ?å¤§é«˜åº¦ï¼Œä¿æŒåŽŸå›¾çš„å®½é«˜æ¯”ç¼©æ”¾
//     * @param imageResId å›¾ç‰‡èµ„æºid
//     * @param maxWidth  å›¾ç‰‡æ˜¾ç¤ºçš„æœ€å¤§å®½åº?
//     * @param maxHeight å›¾ç‰‡æ˜¾ç¤ºçš„æœ€å¤§é«˜åº?
//     * @return
//     */
...
//        };
   // }
    ...
    public static void compress(File file, File outFile , int maxWidth, int maxHeight) {
