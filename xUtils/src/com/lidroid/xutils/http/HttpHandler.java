    ...
    private ResponseInfo<T> handleResponse(HttpResponse response) throws HttpException, IOException {
        ...
        if (statusCode < 300) {
            ...
            throw new HttpException(statusCode, "maybe the file has downloaded completely");
             ...
             new HttpException(statusCode, status.getReasonPhrase() );
            throw new HttpException(statusCode, status.getReasonPhrase() , new ResponseInfo<String>(response, (String) result, false));
        }
        return null;
    }
